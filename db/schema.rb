...
ActiveRecord::Schema.define(version: 20_180_131_192_224) do
  ...
  create_table 'search_filters', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['city_id'], name: 'index_search_filters_on_city_id'
    t.index ['topic_id'], name: 'index_search_filters_on_topic_id'
